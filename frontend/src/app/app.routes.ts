...
export const routes: Routes = [
  ...
  { path: 'admin/sales', component: AdminComponent, canActivate: [adminGuard], data: { tab: 1 } },
  { path: 'admin/notifications', component: AdminComponent, canActivate: [adminGuard], data: { tab: 2 } },
  { path: '**',       redirectTo: ''               }
];